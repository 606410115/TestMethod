...
public class MyoImuTrainingData {
    private static final String MYO_IMU_TRAINING_DATA = "@relation ads\n" +
            "\n" +
            ...
            "\n" +
            "@data\n";
    public String getMyoImuTrainingData(){
        return MYO_IMU_TRAINING_DATA;
    }
}
